...
public:
    ...
    server::Server::Response<User> sign_up(const std::string& email, const std::string& name, const std::string& password);
    server::Server::Response<User> sign_in(const std::string& email, const std::string& password);
    ...
    server::Server::Response<std::vector<Deposit>> get_deposits(double duration_min, double duration_max, double percent_min, double percent_max, long long sum_min, bool reqSalary, bool reqBroker, bool reqPremium);
...
public:
    ...
    server::Server::Response<std::vector<Deposit>> get_deposits(
        double duration_min = 1, double duration_max = 36,
